...
<body class="creamy-white playwrite-de-grund-font bold-text">
    <main>
        <br> <br> <br> <br> <br>
        <h1 class="center blush-pink-text">You have logged out of your account!</h1>
        <br> <br>
        <div class="center">
            <a href="index.php" class="btn btn-large btn-flat blush-pink creamy-white-text"><i class="material-icons">home</i> Back to home</a>
            <a href="login.php" class="btn btn-large btn-flat blush-pink creamy-white-text">Login</a>
        </div>
    </main>
</body>
</html>