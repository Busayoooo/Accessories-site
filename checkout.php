...
<body class="creamy-white playwrite-de-grund-font bold-text">
    <main>
        <div class="container">
        <br> <br> <br> 
        <h1 class="center blush-pink-text">Thank you for ordering ❤</h1>
        <h1 class="center blush-pink-text">Your Order has been completed successfully!</h1>
        <br> <br>
        <div class="center">
            <input type="submit" class="btn btn-large btn-flat blush-pink creamy-white-text" value="Track Order" name="track_order" id="track-order">
            <a href="./index.php" class="btn btn-large btn-flat blush-pink creamy-white-text">Back Home</a>
        </div>
        </div>
    </main>
</body>
